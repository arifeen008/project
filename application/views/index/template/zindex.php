		...
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				<a class="navbar-brand" href="index.html">
					<h2>สหกรณ์อิสลามษะกอฟะฮ จำกัด</h2>
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="services.html">สวัสดิการ</a>
						</li>
						<li class="nav-item">
			...
			<div class="item item-3">
				<div class="img-fill">
					<div class="text-content">
						...
						<p>
							Vivamus ut tellus mi. Nulla nec cursus elit, id vulputate mi. Sed nec cursus augue. Phasellus lacinia ac sapien vitae dapibus. Mauris ut dapibus velit cras interdum nisl ac urna tempor mollis.
						</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<span>Mauris ut dapibus velit cras interdum nisl ac urna tempor
						mollis.</span>
				</div>
				<div class="col-md-4">
					<a href="contact.html" class="border-button">ติดต่อ</a>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="col-md-6 align-self-center">
								<div class="right-content">
									...
									<p>
										...
										<br /><br />Praes end at dictum metus. Morbi id hendrerit lectus, nec dapibus ex. Etiam ipsum quam, luctus eu egestas eget, tincidunt
									</p>
									<a href="#" class="filled-button">Read More</a>
								</div>
							</div>
