...
<div class="col-lg-9">
    <div class="col-12" id="main">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">สัญญาสินเชื่อที่ปิดไปแล้ว คุณ<?php echo $member->FNAME ?> <?php echo $member->LNAME ?></h1>
        </div>
        <div class="row">
            <div class="col">
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <?php if ($result->result() == null) { ?>
                            <td colspan="6" align="center">ไม่มีข้อมูลสินเชื่อที่ปิดไปแล้ว</td>
                        <?php  } ?>
                        <?php foreach ($result->result() as $row) { ?>
                            <tr align="center">
                                ...
                                <td><a href="<?php echo site_url('manager/checkcredit_officer_detail/' . $row->CODE . '/' . $row->BR_NO)  ?>" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
