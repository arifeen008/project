    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <div class="list-group border border-5 border-success">
                <a href="<?php echo site_url('officer/member_share_system') ?>" class="list-group-item border border-success  list-group-item-action">ระบบทะเบียนสมาชิกและหุ้น</a>
                ...
                <a href="<?php echo site_url('officer/takaful_system') ?>" class="list-group-item border border-success list-group-item-action">ระบบกองทุนตะกาฟุล</a>
