<div class="col-lg-9">
	<div class="card my-3">
		<div class="card-body text-dark">
			...
			<a href="<?php echo site_url('officer/reportexcel_member_allbranch/' . $variable['start'] . '/' . $variable['to']) ?>" class="btn btn-success mb-2"><i class="fas fa-file-download me-3"></i>ดูไฟล์ Excel</a>
