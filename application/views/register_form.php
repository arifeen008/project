						...
						<div class="row justify-content-center">
							<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
								...
								<form class="mx-1" action="<?php echo site_url('member/register') ?>" method="POST">
									...
									<div class="d-flex flex-row align-items-center mb-4">
										...
										<div class="form-outline form-floating flex-fill mb-2">
											<input type="password" class="form-control" id="floatingPassword" name="repassword">
							...
							<div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
								<div data-mdb-perfect-scrollbar="true" style="position: relative; width: 600px; height: 400px">
									Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus incidunt blanditiis fugiat modi ut. Facilis doloremque vel, laudantium provident atque nulla corrupti nam! Hic quia culpa iste perspiciatis quibusdam consequuntur.
									Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi cumque magnam placeat eum praesentium ipsam, eveniet ut maxime fugiat perspiciatis totam veniam aspernatur sapiente mollitia fuga adipisci minima ex id?
									Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus incidunt blanditiis fugiat modi ut. Facilis doloremque vel, laudantium provident atque nulla corrupti nam! Hic quia culpa iste perspiciatis quibusdam consequuntur.
									Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi cumque magnam placeat eum praesentium ipsam, eveniet ut maxime fugiat perspiciatis totam veniam aspernatur sapiente mollitia fuga adipisci minima ex id?
									Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus incidunt blanditiis fugiat modi ut. Facilis doloremque vel, laudantium provident atque nulla corrupti nam! Hic quia culpa iste perspiciatis quibusdam consequuntur.
									Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi cumque magnam placeat eum praesentium ipsam, eveniet ut maxime fugiat perspiciatis totam veniam aspernatur sapiente mollitia fuga adipisci minima ex id?
